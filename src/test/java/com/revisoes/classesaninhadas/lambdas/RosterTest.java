package com.revisoes.classesaninhadas.lambdas;
...
import com.revisoes.classesaninhadas.lambdas.Roster.CheckPerson;
...
public class RosterTest {
    ...
    public void setup() {
        ...
        personStream = roster.stream().filter(p -> p.getGender() == Person.Sex.MALE && p.getAge() >= 18 && p.getAge() <= 25);
    }
